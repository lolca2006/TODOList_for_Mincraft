...
public class HudEditScreen extends Screen {
    ...
    protected void init() {
        super.init();
        hudX = Services.CONFIG.hudX();
        hudY = Services.CONFIG.hudY();
    }
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        float scale = Services.CONFIG.hudScale();
        float opacity = Services.CONFIG.hudOpacity();
    ...
    public void onClose() {
        // Save position
        Services.CONFIG.setHudX(hudX);
        Services.CONFIG.setHudY(hudY);
        super.onClose();
    }
